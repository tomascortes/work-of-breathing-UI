...
class Analiser(QMainWindow):
    def __init__(self, data_edi, data_pes):
        ...
        self.label_actual_lower_max1 = QLabel(str(self.lower_max_1), self)
        ...
        self.label_actual_higer_min1 = QLabel(str(-self.higer_min_1), self)
        ...
        self.label_actual_lower_max2 = QLabel(str(self.lower_max_2), self)
        ...
        self.label_actual_higher_min2 = QLabel(str(-self.higer_min_2), self)
    ...
    def edi_button_clicked(self):
        if self.higher_min_input1.text() != "":
            try:
                self.higer_min_1 = -float(self.higher_min_input1.text())
                self.label_actual_higer_min1.setText(str(-self.higer_min_1))
            except:
                pass

        if self.lower_max_input1.text() != "":
            try:
                self.lower_max_1 = float(self.lower_max_input1.text())
                self.label_actual_lower_max1.setText(str(self.lower_max_1))
            except:
                pass

        self.plot_edi.plot_peaks(self.lower_max_1, self.higer_min_1)

    def pes_button_clicked(self):

        if self.higher_min_input2.text() != "":
            try:
                self.higer_min_2 = -float(self.higher_min_input2.text())
                self.label_actual_higher_min2.setText(str(-self.higer_min_2))
            except:
                pass

        if self.lower_max_input2.text() != "":
            try:
                self.lower_max_2 = float(self.lower_max_input2.text())
                self.label_actual_lower_max2.setText(str(self.lower_max_2))
            except:
                pass

        self.plot_pes.plot_peaks(self.lower_max_2, self.higer_min_2)
...
class WidgetPlot(QWidget):
    ...
    def plot_peaks(self, lower_max, higer_min):
        peaks, antipeaks = get_signal_peaks(
            self.data, 0, len(self.data), lower_max, higer_min)
